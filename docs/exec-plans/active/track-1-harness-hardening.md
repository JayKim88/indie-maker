...
> **목표**: 텍스트 약속에 의존하던 부분을 하네스 레이어(hooks/scripts/statusline)로 자동화하고, 부서진 부분을 수선
> **베이스**: 실사용 분석 (skills 동기화 상태, docs 경로 누수, 6-프로젝트 병렬 운영)
> **소속 릴리스**: v0.1 — Harness Hardening (`../../../ROADMAP.md`)
...
- [`../../../ROADMAP.md`](../../../ROADMAP.md) — 릴리스 마일스톤 (v0.1)
- [`../../../CLAUDE.md`](../../../CLAUDE.md) — 현재 스코프 규칙
- [`../../../README.md`](../../../README.md) — 사용자 진입 흐름
- `~/.claude/plans/bubbly-toasting-raccoon.md` — L5 상세 계획 (재사용 자산, 검증 매트릭스 포함)
- [`./harness-upgrade.md`](./harness-upgrade.md) — OpenAI 개념 적용 고도화 체크리스트 (보조)
